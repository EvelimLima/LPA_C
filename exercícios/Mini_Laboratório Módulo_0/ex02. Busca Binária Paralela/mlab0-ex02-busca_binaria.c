...
//Dado um vetor ordenado, divida-o entre duas threads, cada uma fazendo busca binária em sua
//metade. Retorne o índice encontrado (ou -1) para a thread principal.
